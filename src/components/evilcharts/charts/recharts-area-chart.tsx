    ...
    return (
        <>
            ...
            <defs>
                ...
                {variant === "solid" && (
                    <SolidPattern id={id} dataKey={dataKey} />
                )}
                {variant === "dotted" && (
                    <DottedPattern id={id} dataKey={dataKey} />
                )}
                {variant === "lines" && (
                    <LinesPattern id={id} dataKey={dataKey} />
                )}
                {variant === "hatched" && (
                    <HatchedPattern id={id} dataKey={dataKey} />
                )}
                {showUnselected && (
                    <UnselectedPattern id={id} dataKey={dataKey} />
                )}
            </defs>
        </>
    );
...
function YAxis({
    ...
    return (
        <RechartsYAxis
            ...
            width={width}
            tickFormatter={
                isExpanded ? axisValueToPercentFormatter : tickFormatter
            }
            {...props}
        />
    );
