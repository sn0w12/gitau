...
export function DialogViewport({
    ...
    return (
        <DialogPrimitive.Viewport
            ...
            className={cn(
                "fixed inset-0 z-50 grid grid-rows-[1fr_auto_3fr] justify-items-center p-4 clip-inset-backdrop",
                className
            )}
            {...props}
        />
...
export function DialogPanel({
    ...
    return (
        <ScrollArea overscrollContain scrollFade={scrollFade} fill={fill}>
            {useRender({
                defaultTagName: "div",
                props: mergeProps<"div">(defaultProps, props),
                render,
